...
from video_summary.threads.save_video_thread import SaveVideo
...
class ThreadsController:
    ...
    save_video_thread = SaveVideo(scenes_analysis_thread, objects_analysis_thread,
                                  subtitles_analysis_thread, resume_thread)
